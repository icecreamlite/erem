// https://camposha.info/android-examples/android-websocket/#gsc.tab=0
...
object  WebSocketManager {
    ...
    private  const  val  MILLIS  =  2000  // Reconnection interval, milliseconds
    ...
    fun init(wsIp: String, _messageListener: MessageListener) {
        val url = "ws://" + wsIp + ":1337"
    ...
    fun initConnect(ip: String, msgLstnr: MessageListener) {
        init(ip, msgLstnr)
